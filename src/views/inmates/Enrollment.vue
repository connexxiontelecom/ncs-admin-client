<template>
  <div>
    ...
    <!-- Page Content -->
    <div class="content">
      <h2 class="content-heading">Inmate Enrollment Form</h2>
      <b-form @submit.stop.prevent="onSubmit">
        <b-tabs id="form-block" class="block" nav-class="nav-tabs-block " content-class="block-content overflow-hidden" >
