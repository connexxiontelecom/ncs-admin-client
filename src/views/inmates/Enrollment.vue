<template>
  <div>
    ...
    <div class="content">
      <!-- Your Block -->
      <base-block rounded title="Inmate Enrollment Form" ref="enrollmentForm" btn-option-fullscreen>
        <b-form @submit.stop.prevent="onSubmit" class="mb-2">
          <b-row>
            <b-col lg="12">
              <h6 class="content-heading border-bottom mb-4 pb-1">Personal Information</h6>
            </b-col>
          </b-row>
          <b-row>
            <b-col lg="2">
          ...
          <b-row>
            <b-col lg="6">
              <b-form-group label="Street Address" label-for="address">
                <b-form-textarea id="address" name="address" v-model="$v.enrollmentForm.address.$model" :state="!$v.enrollmentForm.address.$error && null" rows="3"></b-form-textarea>
                <b-form-invalid-feedback>
          ...
          <b-row>
            <b-col lg="6">
              <b-form-group label="Spouse Information" label-for="spouse-info">
                <b-form-textarea id="spouse-info" name="spouseInfo" v-model="$v.enrollmentForm.spouseInfo.$model" :state="!$v.enrollmentForm.spouseInfo.$error && null" rows="3"></b-form-textarea>
              </b-form-group>
              <b-form-invalid-feedback>
            ...
            <b-col lg="6">
              <b-form-group label="Next of Kin Information" label-for="nok-info">
                <b-form-textarea id="nok-info" name="nokInfo" v-model="$v.enrollmentForm.nokInfo.$model" :state="!$v.enrollmentForm.nokInfo.$error && null" rows="3"></b-form-textarea>
              </b-form-group>
              <b-form-invalid-feedback>
...
<!--          crime/court information -->
          <b-row>
            <b-col lg="12">
              <h6 class="content-heading border-bottom mb-4 pb-1">Crime/Court Information</h6>
            </b-col>
          </b-row>
          <b-row>
            <b-col lg="3">
...
<!--          health information-->
          <b-row>
            <b-col lg="12">
              <h6 class="content-heading border-bottom mb-4 pb-1">Health Information</h6>
            </b-col>
          </b-row>
          <b-row>
            <b-col lg="3">
          ...
          <b-row>
            <b-col>
              <b-form-group>
                <b-button type="reset" variant="alt-secondary" class="float-right mr-2" v-click-ripple>Reset</b-button>
                <b-button type="submit" variant="alt-primary" class="float-right mr-2" v-click-ripple>Enroll Inmate</b-button>
              </b-form-group>
            </b-col>
          </b-row>
        </b-form>
